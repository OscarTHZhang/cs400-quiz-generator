...
/**
 * Graphics interface for a quiz. Containing a question , selection box, and options to move to next question or back to last question
 * 
 * @author Bradley
 *
 */
...
>>>>>>> 1ce31109d93f498237c675db528b261bb1affca3
		...
		allQuestions.add(q3);
<<<<<<< HEAD
		quiz.setQuestions(allQuestions);  // all this are added for demo. quiz will take different parameter after completion
 ...
 */
	private BorderPane setBorderPane() {
     ...
     // process question title - Start
		...
		Label questionLabel = new Label("Question " + (quiz.getCurrentQuestionIndex()+1) + " out of " + questionCount + ": ");
